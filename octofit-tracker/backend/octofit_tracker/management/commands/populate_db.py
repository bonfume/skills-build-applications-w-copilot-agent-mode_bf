...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create activities
        activities = [
            Activity(user=users[0], activity_type='Cycling', duration=60, date='2025-04-24'),
            Activity(user=users[1], activity_type='Crossfit', duration=120, date='2025-04-23'),
            Activity(user=users[2], activity_type='Running', duration=90, date='2025-04-22'),
            Activity(user=users[3], activity_type='Strength', duration=30, date='2025-04-21'),
            Activity(user=users[4], activity_type='Swimming', duration=75, date='2025-04-20'),
        ]
